...
export default function NewsIndex() {
  return (
    <div className="space-y-6">
      <div>
        <Link className="text-sm opacity-70 hover:underline" href="/archive">← Back</Link>
      ...
      <div className="grid gap-3">
        <Link className="border border-white/10 rounded-2xl p-5 bg-white/2 hover:bg-white/4 transition" href="/archive/news/public">
        ...
        <Link className="border border-white/10 rounded-2xl p-5 bg-white/2 hover:bg-white/4 transition" href="/archive/news/players">
        ...
        <Link className="border border-white/10 rounded-2xl p-5 bg-white/2 hover:bg-white/4 transition" href="/archive/news/devlog">
