      ...
      <div className="border border-white/10 rounded-2xl p-6 bg-white/2">
        <div className="space-y-3">
          ...
          <p className="text-sm opacity-70 leading-relaxed max-w-xl">
            This section will contain the canonical rules and boundaries: posting etiquette,
            IC/OOC rules, content boundaries, and moderation basics.
          </p>
...
export default function Page() {
  return (
    <ArchivePlaceholder
      title="Rules"
      subtitle="Boundaries, etiquette, posting rules."
      tag="SYSTEMS"
      backHref="/world/systems"
    />
  );
